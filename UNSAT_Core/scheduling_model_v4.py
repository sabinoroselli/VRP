...
def schedule(locations,edges, paths_combo, paths_combo_edges,capacity_unsat_constraints):
    ...
    while last_iteration <= 1:          # -- Stop looping when we have reached our last + 1 iteration
        ...
        # -- 23/24 Precedence constraints amongst nodes and edges visited in a route
        for route_index, route in enumerate(locations):
        ...
        if s.check() == unsat and last_iteration == 0:
